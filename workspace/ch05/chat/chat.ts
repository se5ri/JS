...
const createRoomBtn =
  document.querySelector<HTMLButtonElement>("#createRoomBtn")!;

/** 채팅방 입장 관련 DOM 요소들 */
const enterRoomId = document.querySelector<HTMLInputElement>(
  '[name="enterRoomId"]'
)!;
...
const leaveRoomBtn =
  document.querySelector<HTMLButtonElement>("#leaveRoomBtn")!;

/** 채팅방 정보 표시 및 조회 관련 DOM 요소들 */
const connectedRoom =
  document.querySelector<HTMLSpanElement>("#connectedRoom")!;
