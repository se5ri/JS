...
Function.prototype.memoize = function () {
  ...
  return function () {
    return fn.memo.apply(fn, arguments); //fn=this, arguments[0]=key값을 받음 (매개변수) = isPrime.memo(5)
  };
};
...
mylib.inherite = function (Parent, Child) {
  ...
  College.prototype.constructor = Child;
};
