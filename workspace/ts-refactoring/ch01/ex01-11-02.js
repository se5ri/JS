...
// 4-1. null === undefined
// 예측:
var emptyVal; //undefined 타입, undefined
var nullVal = null; //object타입, 값은 null
...
// 비교 연산자만 사용하여 최댓값 찾기
maxNum = (num2 > maxNum) * num2 + (num2 <= maxNum) * maxNum;
maxNum = (num3 > maxNum) * num3 + (num3 <= maxNum) * maxNum;
maxNum = (num4 > maxNum) * num4 + (num4 <= maxNum) * maxNum;
