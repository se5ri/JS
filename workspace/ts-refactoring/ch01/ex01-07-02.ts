...
(() => {
  ...
  // Symbol 비교
  let s11: symbol = Symbol("hello"); // 'hello'라는 설명을 가진 Symbol 생성
  let s22: symbol = Symbol("world"); // 'world'라는 설명을 가진 Symbol 생성
  let s33: symbol = Symbol("hello"); // 'hello'라는 설명을 가진 새로운 Symbol 생성
